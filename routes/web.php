...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/quiz/{quiz}/easyStart', [QuizController::class, 'easyStart'])->name('quiz.easyStart');
    Route::get('/quiz/{quiz}/mediumStart', [QuizController::class, 'mediumStart'])->name('quiz.mediumStart');

    Route::post('/quiz/{quiz}/submitEasy', [QuizController::class, 'submitEasy'])->name('quiz.submitEasy');
    Route::post('/quiz/{quiz}/submitMedium', [QuizController::class, 'submitMedium'])->name('quiz.submitMedium');
});
