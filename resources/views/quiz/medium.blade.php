...
<div class="p-2 w-full  flex justify-center">
  <div class="sm:w-[300px] md:w-[600px]">
    <h3 class="text-center text-xl font-semibold mb-4">Quiz Level Medium</h3>
    <div class="flex justify-evenly flex-wrap gap-2 ">
      ...
      <div class="mt-6 border p-2 shadow-lg w-full sm:w-[250px]">
        ...
        <a href="{{ route('quiz.mediumStart', $quiz->id) }}">
          <div
            class="my-2 text-center text-slate-700 py-2 border border-yellow-500 rounded hover:text-white hover:bg-yellow-500">
            Start Quiz
          </div>
